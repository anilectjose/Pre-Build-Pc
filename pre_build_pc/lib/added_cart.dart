...
import 'package:pre_build_pc/cart.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'Prebuild_pc.dart';
import 'cart_2.dart';
import 'customize_pc.dart';

class added_Cart extends StatefulWidget {
  String id,typeId;
  added_Cart({Key key, @required this.id,this.typeId}) : super(key: key);

  @override
  _added_CartState createState() => _added_CartState(id: id,typeid:typeId);
}

class _added_CartState extends State<added_Cart> {
  String id,Roleid,typeid;
  _added_CartState({this.id,this.typeid});
  ...
  Future updateCart(String id,String Roleid,String typeid) async{
    final SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    var Roleid = sharedPreferences.getString('roleId');
    var url = Prebuild_pc.BaseURL + "add_product.php";
    var data = {"prodid": id,"typeid": typeid,"roleid": Roleid};
