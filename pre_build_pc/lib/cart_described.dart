...
class Cart_desc extends StatefulWidget {
  String id;

  Cart_desc({Key key, @required this.id}) : super(key: key);

  @override
  _Cart_descState createState() => _Cart_descState(id: id);
}

class _Cart_descState extends State<Cart_desc> {
  var compCon = new TextEditingController();
  String id, RoleId, comp;

  _Cart_descState({this.id});
  ...
  SaveData() async {
    ...
    print(RoleId);
    var url = Prebuild_pc.BaseURL + "make_order.php";
    var credit = {"cartid": id, "roleid": RoleId,"custom":comp};
  ...
  Future getData() async {
    ...
    var credit = {"compid": id,"roleid": Roleid};
    ...
    return Scaffold(
                ...
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          children: <Widget>[
                            //IF YOU NEED A LIST VIEW OF CART IT IS ALSO CREATED IN THE NAME OF CART.DART
                            /*ListTile(
                              title: Text('Device:',
                                  style: TextStyle(
                                      fontFamily: 'Poppins',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          ...
          SaveData();
          Fluttertoast.showToast(msg: "Order placed..",backgroundColor: Colors.transparent);
        },
        backgroundColor: Prebuild_pc.themecolor,
